/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4852c302cb3585734b3e4f779bcfe9c3)
...
declare namespace Cloudflare {
	interface Env {
		...
		API_CONTAINER: DurableObjectNamespace<import("./js/src/index").APIContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "DATABASE_URL" | "DATABASE_AUTH_TOKEN">> {}
}
