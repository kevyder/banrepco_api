/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 17728b735bceac228956deec6243f061)
// Runtime types generated with workerd@1.20251011.0 2025-11-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./js/src/index");
		durableNamespaces: "APIContainer";
	}
	interface Env {
		CACHE_EXPIRATION_TTL: "60" | "3600";
		BANREP_WEB_SERVICE_URL: "https://totoro.banrep.gov.co/nsi-jax-ws/rest/data";
		INFLATION_WEB_SERVICE_URL: "https://suameca.banrep.gov.co/estadisticas-economicas-back/rest/estadisticaEconomicaRestService/consultaMenuXId?idMenu=100001";
		ENVIRONMENT: string;
		DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CACHE_EXPIRATION_TTL" | "BANREP_WEB_SERVICE_URL" | "INFLATION_WEB_SERVICE_URL" | "ENVIRONMENT" | "DATABASE_URL" | "DATABASE_AUTH_TOKEN">> {}
}
